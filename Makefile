...
CFLAGS = -MMD -MP -I$(HELPERINC) -I$(MOLTNINC) -I$(OIBINC) -I$(GAMEINC) -I$(FORMINC) -I$(AUDIOINC) -I$(RENDERINC) -I$(INCDIR) -I.
LDFLAGS =
...
main.o: main.c snake.c snake.h constants.h dirt.c dirt.h stat.c stat.h plant.c plant.h grass.c grass.h flower.c flower.h water.c water.h garden.c garden.h stone.c stone.h rainbow.c rainbow.h poop.c poop.h GM.c GM.h floaty.c floaty.h mass.c mass.h clouds.c clouds.h
